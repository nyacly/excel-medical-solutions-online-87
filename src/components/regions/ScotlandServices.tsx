...
const ScotlandServices = () => {
  const services = [
    ...
    },
    {
      ...
      suitableFor: ["Small Events", "Workplace Safety", "Community Events", "Educational Institutions"]
    }
  ];
    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">
          Our Medical Services in Scotland
        </h2>
            ...
            <Card key={index} className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="bg-gray-100 p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                  <service.icon className="h-6 w-6" style={{ color: '#006400' }} />
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {service.suitableFor.map((item, idx) => (
                      <span key={idx} className="text-black text-xs px-2 py-1 rounded" style={{ backgroundColor: '#d2f406' }}>
                        {item}
                      </span>
                    ))}
                  </div>
...
export default ScotlandServices;
