...
const NorthWestFirstAidMedicalCover = () => {
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        url="https://excelems.co.uk/north-west-first-aid-medical-cover"
        localBusinessSchema={{
        ...
        breadcrumbs={[
          ...
          { name: "North West First Aid Medical Cover", url: "https://excelems.co.uk/north-west-first-aid-medical-cover" }
        ]}
      />
      <Header />
...
export default NorthWestFirstAidMedicalCover;
